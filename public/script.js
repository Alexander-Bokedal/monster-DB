...
const updateMonsterSliders = () => {
  ...
  dom.monsterSliders.innerHTML = editableSliders.map((obj) => obj.html).join("");
...
dom.testButton.addEventListener("click", (e) => {
  ...
  monsters.push({
    name: variable.randomNames[Math.floor(Math.random() * variable.randomNames.length)], // Sätt namnet på monstret till "Test Monster"
    monsterDiet:
      variable.monsterDiets[Math.floor(Math.random() * variable.monsterDiets.length)].icon,
    // Välj en slumpmässig diet från "monsterDiets" arrayen
    monsterType:
      variable.monsterTypes[Math.floor(Math.random() * variable.monsterTypes.length)].icon,
    // Välj en slumpmässig typ från "monsterTypes" arrayen
    monsterSize:
      variable.monsterSizes[Math.floor(Math.random() * variable.monsterSizes.length)].icon,
...
const randomDeleteSound = () => {
  ...
  const randomIndex = Math.floor(Math.random() * variable.randomDeleteSounds.length);
